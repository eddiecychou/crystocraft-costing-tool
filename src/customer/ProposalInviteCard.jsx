...
export default function ProposalInviteCard({ status, href }) {
  ...
  return (
    <Link to={href}
      className="card group flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-6 px-6 py-6 hover:border-brand-300 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2">
      <div>

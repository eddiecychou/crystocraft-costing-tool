    ...
    <div className="bp-doc">
      <style>{`
        ...
        .bp-doc { font-family: 'Helvetica Neue', Arial, sans-serif; color: #1a1a1a; font-size: 10.5px; line-height: 1.5;
          background: #fff; padding: 32px clamp(16px, 5vw, 48px); max-width: 960px; margin: 0 auto; }
        ...
        .bp-hero { margin-bottom: 24px; page-break-inside: avoid; break-inside: avoid; }
        ...
        .bp-section { margin-bottom: 26px; page-break-inside: avoid; break-inside: avoid; }
        ...
        .bp-foot { margin-top: 26px; padding-top: 10px; border-top: 1px solid #eee; text-align: center; font-size: 9px; color: #888; line-height: 1.6; }

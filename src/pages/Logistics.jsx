  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Logistics Vendors</h1>
          <p className="text-sm text-gray-500 mt-0.5">{filtered.length} of {vendors.length} forwarders</p>
        </div>

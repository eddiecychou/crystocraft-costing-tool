...
await ok('sales read pricing_tiers (to quote)', assertSucceeds(getDoc(doc(sales, 'products/p1/pricing_tiers/t0'))))
...
await ok('sales DENIED write pricing_tiers (cost-derived editor)', assertFails(setDoc(doc(sales, 'products/p1/pricing_tiers/t9'), { price: 9 })))
await ok('sales DENIED write customer_prices',  assertFails(setDoc(doc(sales, 'products/p1/customer_prices/cust1'), { price: 9 })))

...
components/
  core/
    ...
    FacetDivider         ← Hairline rule with a restrained crystal-facet glyph
    CraftNote            ← Atelier margin annotation — pin marker + label + note
  forms/
...
guidelines/
  ...
  composition-image-text.card.html ← Editorial image/text composition patterns
templates/
  ...
  proposal/index.html    ← Bespoke Gifting client proposal document
```
